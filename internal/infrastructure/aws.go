...
// AWSProvider handles AWS-specific provisioning
...
// Provision provisions AWS infrastructure
...
// GCPProvider handles GCP-specific provisioning
...
// AzureProvider handles Azure-specific provisioning
...
func (azp *AzureProvider) Provision(ctx context.Context, config *InfrastructureConfig) (*ProvisioningResult, error) {
	...
	// Azure provisioning logic would go here
